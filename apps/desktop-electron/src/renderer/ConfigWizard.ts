...
export class ConfigWizard {
  ...
  constructor() {
    ...
    this.input = document.getElementById('worktree-input') as HTMLInputElement;
    this.saveBtn = document.getElementById('wizard-save-btn') as HTMLButtonElement;
   ...
   * 检查是否需要显示配置向导
   */
  async checkAndShow(onComplete?: () => void): Promise<boolean> {
 ...
 * 创建配置向导实例
 */
export function createConfigWizard(): ConfigWizard {
